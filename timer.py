...
window = Tk()
window.title("Sheepometer")
canvas = Canvas(window, width=1000, height=500)
#window.geometry('1000x500')
background = ImageTk.PhotoImage(Image.open("/\\gathering_database_background.png"))
canvas.create_image(0,0,anchor=NW, image=background)
stopwatch_counter_num = 255600
stopwatch_running = False
timer_counter_num = 255600
timer_running = False
def clock():
...
tabs_control.add(clock_tab, text="Main")
...
time_label = Label(clock_tab, font = 'calibri 10 bold', foreground = 'black')
time_label.pack(anchor='e')
date_label = Label(clock_tab, font = 'calibri 10 bold', foreground = 'black')
